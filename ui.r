...
#####################################Do Your Own##############################################################
                        ...
                        tabItem(tabName = "ratings_change",
                                ...
                                p("What was the reason that the redoing study was changed or kept the same along this dimension, relative to the original study? (Hover over dimensions and keep mouse still for detailed explanation.) Please select 'Not applicable', if there were no changes on the respective dimension.", class="custom-text"),
                                shinysurveys::radioMatrixInput(
                        ...
                        radioButtons(inputId="part_conf2",
                                     label=div("Please confirm once again your initial consent for the anonymized evaluation of the responses or revoke it.",
