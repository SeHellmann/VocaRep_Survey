...
#####################################Do Your Own##############################################################
                        ...
                        tabItem(tabName = "ratings_change",
                                ...
                                p("Please indicate to which extent your redoing activity deviates from the initial study across the different dimensions. (Hover over dimensions for detailed explanation.)", class="custom-text"),
                                shinysurveys::radioMatrixInput(
                        ...
                        tabItem(tabName = "outcome_changes",
                                ...
                                radioGroupButtons("observedchange", "To what extent did the results from your redoing study deviate from the results of the original study?",
